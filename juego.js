...
function elemento(uno, dos) {
  ...
  if (uno == 1) {
    ...
    anim = document.getElementsByClassName('auno');
    for(var x=0; x<anim.length; x++){
    anim[x].style.opacity=0;
    }
    verdad = 1;
    } else{
     verdad = 0;
     ...
     verdad = 1;
     anim = document.getElementsByClassName('ados');
     for(var x=0; x<anim.length; x++){
     anim[x].style.opacity=0;
     }
    }else{
...
function memoria(i){
  if (intentos == 1){
    ...
    intentos++;
      ...
      dos = i;
      intentos = 1;
      var anim = document.getElementsByClassName('auno');
...
function reiniciar() {
  ...
  for (var x = 0; x < elem.length; x++) {
   ...
   var anim = document.getElementsByClassName('auno');
   for(var x=0; x<anim.length; x++){
   anim[x].style.opacity=1;
   elem[x].style.display = 'block';
   }

   var anim = document.getElementsByClassName('ados');
   for(var x=0; x<anim.length; x++){
   anim[x].style.opacity=1;
   elem[x].style.display = 'block';
   }
